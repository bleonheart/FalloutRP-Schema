...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/nailboard.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(4.276, -21.413, 10.803), angle = Angle(5.842, 90.027, 9.885), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/nailboard.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.914, 23.989, 0.312), angle = Angle(156.328, 75.802, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Melee/nailboard.mdl"
