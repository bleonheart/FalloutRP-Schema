...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/brassknuckles.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(4.197, 0.061, 0.479), angle = Angle(180, -180, -90.338), size = Vector(1.202, 1.202, 1.202), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/brassknuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.933, 0.435, 0.551), angle = Angle(-166.084, 180, 90), size = Vector(1.338, 1.338, 1.338), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Melee/brassknuckles.mdl"
...
function SWEP:PrimaryAttack()
	...
	self.Weapon:SetNextPrimaryFire(CurTime() + self.Primary.Delay + math.random(-15,5)/100)
