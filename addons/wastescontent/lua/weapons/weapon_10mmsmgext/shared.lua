...
if (CLIENT) then
SWEP.VElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/10mmsmgextclip.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-2.32, -8.322, 2.928), angle = Angle(-169.946, -153.732, -1.329), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
SWEP.IronSightsPos = Vector(5.685, -1.5, 0.957)
SWEP.IronSightsAng = Vector(-0.27, 2.47, -2)
