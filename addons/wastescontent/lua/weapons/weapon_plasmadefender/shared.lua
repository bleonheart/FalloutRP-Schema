...
local LaserHitImpact = function(attacker, tr, dmginfo)
	...
	util.Effect("effect_fo3_plasmahit", laserhit)
...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmadefender.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.019, -1.359, -3.359), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmadefender.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.086, 1.766, 1.092), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmadefender.mdl"
...
SWEP.Primary.Sound 			= Sound("weapons/plasmadefender/wpn_plasmadefender_fire.wav")
SWEP.Primary.Recoil			= .15
SWEP.Primary.Damage			= 30   
SWEP.Primary.NumShots		= 1
SWEP.Primary.Cone 			= .02
SWEP.Primary.Delay 			= 1.333333

SWEP.Primary.ClipSize		= 30					// Size of a clip
SWEP.Primary.DefaultClip	= 0					// Default number of bullets in a clip
SWEP.Primary.Automatic		= true				// Automatic/Semi Auto
SWEP.Primary.Ammo			= "EnergyCell"
...
SWEP.IronSightsPos = Vector(4.532, -2, 1.252)
SWEP.IronSightsAng = Vector(-0.348, 0.071, 0)
