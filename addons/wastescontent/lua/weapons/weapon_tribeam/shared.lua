...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/tribeamlaserrifle.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(8.1, 2.141, 2.101), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/tribeamlaserrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.456, 0.764, 2.724), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Energy Weapons/tribeamlaserrifle.mdl"
...
SWEP.Primary.Sound 			= Sound("weapons/laserrifle/wpn_lasertribeam_fire_2d_01.wav")
...
SWEP.IronSightsPos = Vector(-5.608, -6, 0.592)
SWEP.IronSightsAng = Vector(0, 0, -1.499)
...
function SWEP:PrimaryAttack()
	...
	timer.Create( "tribeamlaser_timer", 0.05, 1, function()
		self:RecoilPower()
