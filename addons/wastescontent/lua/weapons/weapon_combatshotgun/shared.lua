...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/combatshotgun.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(-0.253, -0.81, -12.379), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/combatshotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7.726, 1.006, 3.061), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end

SWEP.Base 				= "kermite_base_shotgun_auto"
SWEP.Category			= "Fallout Sweps - Shotguns"
SWEP.HoldType = "ar2"
SWEP.ViewModelFOV = 70
SWEP.ViewModelFlip = true
SWEP.ViewModel = "models/weapons/v_shot_xm1014.mdl"
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Shotguns/combatshotgun.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.Right_Arm"] = { scale = Vector(1, 1, 1), pos = Vector(0.998, -0.843, 0.49), angle = Angle(0, 0, 0) },
	["v_weapon.xm1014_Parent"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
SWEP.Spawnable			= true
SWEP.AdminSpawnable		= false

SWEP.Primary.Sound 		= Sound("weapons/combatshotgun/wpn_shotguncombat_fire_2d.wav")
...
SWEP.IronSightsPos = Vector(4.978, -2.737, 1.3)
SWEP.IronSightsAng = Vector(0.10, 0.9, 0)
