/**
* Scripted weapon based on Fallout: New Vegas' Laser Rifle with the Laser Rifle Beam Splitter modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserriflebeamsplitter.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(8.1, 1.508, 1.024), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserriflebeamsplitter.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.456, 0.764, 2.724), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Energy Weapons/laserriflebeamsplitter.mdl"
...
SWEP.IronSightsPos = Vector(-5.409, -1.5, 1.248)
