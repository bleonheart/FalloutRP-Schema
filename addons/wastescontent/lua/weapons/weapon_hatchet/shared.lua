...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/hatchet.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(3.595, -1.31, -3.822), angle = Angle(-7.252, -89.909, 0.503), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/hatchet.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.753, 1.629, 5.618), angle = Angle(180, -90.003, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Melee/hatchet.mdl"
