...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmapistol.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(-0.22, -1.379, -2.402), angle = Angle(1.023, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmapistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.086, 1.766, 1.8), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmapistol.mdl"
...
SWEP.IronSightsPos = Vector(4.733, -1.5, 1.25)
SWEP.IronSightsAng = Vector(-0.348, 0.985, 0)
