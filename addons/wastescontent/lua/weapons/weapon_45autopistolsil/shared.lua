/**
* Scripted weapon based on Fallout: New Vegas' .45 Auto Pistol with the .45 Auto Pistol Silencer modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/45pistolsil.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.103, -1.241, 0.027), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/45pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.753, 1.679, 0.555), angle = Angle(180, -90, 1), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/45pistol.mdl"
...
SWEP.IronSightsPos = Vector(4.585, -2, 2.742)
SWEP.IronSightsAng = Vector(0.634, -0.205, 0)
