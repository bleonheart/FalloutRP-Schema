/**
* Scripted weapon based on Fallout: New Vegas' Light Machine Gun with the Light MG Expanded Drums modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["heavyweapons"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/lightmachinegunext.mdl", bone = "v_weapon.famas", rel = "", pos = Vector(0.254, 4.15, 1.802), angle = Angle(-180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["heavyweapons"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/lightmachinegunext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.3, 0.796, 2.496), angle = Angle(180, -90, 7.007), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/heavy weapons/lightmachinegunext.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.Left_Arm"] = { scale = Vector(1, 1, 1), pos = Vector(-4.021, 4.697, -4.127), angle = Angle(0, 0, 0) },
	["v_weapon.famas"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}

SWEP.Primary.Sound          = Sound( "weapons/lightmachinegun/wpn_lightmachgun.wav" )
...
SWEP.IronSightsPos = Vector(-4.59, 0.708, 0.74)
