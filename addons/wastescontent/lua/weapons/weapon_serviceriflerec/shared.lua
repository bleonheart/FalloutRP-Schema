/**
* Scripted weapon based on Fallout: New Vegas' Service Rifle with the Service Rifle Forged Receiver modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/battleriflerec.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(5.268, 1.128, 1.439), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/battleriflerec.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.714, 0.56, 2.013), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/AssaultRifles/battleriflerec.mdl"
...
SWEP.IronSightsPos = Vector(-5.59, -2, 2.1)
SWEP.IronSightsAng = Vector(-0.233, -0.257, -0.893)
