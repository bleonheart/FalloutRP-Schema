/**
* Scripted weapon based on Fallout 3's Alien Blaster.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Alien Weapons/aliendisintegrator.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-7.027, 3, -1.851), angle = Angle(93.483, -90, -3.027), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Alien Weapons/aliendisintegrator.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-7.812, 2.367, 4.113), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Alien Weapons/aliendisintegrator.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.Right_Arm"] = { scale = Vector(1, 1, 1), pos = Vector(-0.695, -4.993, -1.162), angle = Angle(10.961, -10.332, 0) },
	["v_weapon.galil"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(-30, 0, 0), angle = Angle(0, 0, 0) }
}

SWEP.EjectDelay				= 0

SWEP.Primary.Sound 		= Sound("weapons/riflealien/wpn_alienrifle_fire.wav")
...
SWEP.IronSightsPos = Vector(-6.924, -2, 2.382)
SWEP.IronSightsAng = Vector(-2.054, -5.443, 0)
...
function SWEP:Reload()
	...
	-- When the current clip < full clip and the rest of your ammo > 0, then
		...
		-- Zoom = 0
	self:EmitSound( "weapons/riflealien/wpn_alienrifle_reload.wav" )
