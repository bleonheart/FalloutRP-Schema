...
SWEP.Gun = ("weapon_mineplasma") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Plasma Mine"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/mines/plasmamine.mdl"
...
SWEP.Primary.Round 			= ("weapon_mineplasma")	--NAME OF ENTITY GOES HERE
...
SWEP.VElements = {
	["mine"] = { type = "Model", model = "models/halokiller38/fallout/weapons/mines/plasmamine.mdl", bone = "Bip01_R_Hand", rel = "", pos = Vector(4.511, 4.723, -3.733), angle = Angle(90, 38.566, 3.615), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["mine"] = { type = "Model", model = "models/halokiller38/fallout/weapons/mines/plasmamine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.963, 4.993, 2.069), angle = Angle(-103.593, -112.934, 19.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
