...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/grenaderifle.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(1.325, -2.472, -4.823), angle = Angle(5.047, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["launcher"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/grenaderifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.663, 0.435, 1.654), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.PrintName				= "25mm Grenade Rifle"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/explosives/grenaderifle.mdl"
