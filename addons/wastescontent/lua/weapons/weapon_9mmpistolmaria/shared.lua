...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/9mmunique.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.112, -0.928, 0.37), angle = Angle(1.023, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/9mmunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.503, 1.679, 0.488), angle = Angle(180, -90, 1), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/9mmunique.mdl"
...
SWEP.IronSightsPos = Vector(4.752, -1, 2.5)
SWEP.IronSightsAng = Vector(0.05, 0.875, -0.76)
