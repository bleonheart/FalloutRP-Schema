/**
* Scripted weapon based on Fallout: New Vegas' CZ57 Avenger.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["heavyweapons"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/minigununique.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-0.908, 1.893, 0.013), angle = Angle(90, -90, 0.002), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["heavyweapons"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/minigununique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.042, 0.91, 0.887), angle = Angle(163.604, -90, 0.001), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/heavy weapons/minigununique.mdl"
