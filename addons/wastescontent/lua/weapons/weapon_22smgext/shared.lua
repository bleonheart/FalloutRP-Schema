/**
* Scripted weapon based on Fallout: New Vegas' Silenced .22 SMG with the Silenced .22 Submachine Gun Expanded Drums modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/22smgext.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-2.359, -9.188, 2.602), angle = Angle(-169.946, -153.732, -1.329), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/22smgext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.899, 0.976, 1.929), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/SMGs/22smgext.mdl"
...
SWEP.IronSightsPos = Vector(6.07, -2.237, 1.72)
SWEP.IronSightsAng = Vector(-1.2, 2.45, -2.467)
