/**
* Scripted weapon based on Fallout: New Vegas' Grenade Machine Gun.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["bigweapons"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Heavy Weapons/25mmgrndlnchr.mdl", bone = "ValveBiped.Bip01", rel = "", pos = Vector(-3.001, -25.887, -8.513), angle = Angle(-0.538, 90.04, 90.001), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["bigweapons"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Heavy Weapons/25mmgrndlnchr.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-10.193, -0.224, -9.91), angle = Angle(-99.802, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.PrintName				= "Grenade Machinegun"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Heavy Weapons/25mmgrndlnchr.mdl"
