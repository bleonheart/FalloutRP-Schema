/**
* Scripted weapon based on Fallout: New Vegas' 10mm Submachine Gun.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/10mmsmg.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-2.32, -8.322, 2.928), angle = Angle(-169.946, -153.732, -1.329), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/10mmsmg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.001, 1.402, 1.605), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/SMGs/10mmsmg.mdl"
...
SWEP.IronSightsPos = Vector(5.7, -1.5, 0.984)
SWEP.IronSightsAng = Vector(-0.27, 2.47, -2.467)
