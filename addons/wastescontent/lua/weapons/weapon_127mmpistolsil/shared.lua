...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/127mmpistolsilencer.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.184, -2.083, -1.78), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/127mmpistolsilencer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.04, 1.537, 1.172), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/127mmpistolsilencer.mdl"
...
SWEP.IronSightsPos = Vector(4.68, -2, 1.37)
SWEP.IronSightsAng = Vector(-0.141, -0.071, -0.5)
SWEP.RunSightsPos  = Vector (0.0961, 0, 5.9811)
SWEP.RunSightsAng   = Vector (-26.4014, 2.0332, 0)
