...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpdw.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(6.739, 1.508, 0.442), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpdw.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.556, 1.115, 1.985), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.HoldType = "ar2"
SWEP.ViewModelFOV = 66.314960629921
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/weapons/v_rif_galil.mdl"
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Energy Weapons/laserpdw.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.Right_Arm"] = { scale = Vector(1, 1, 1), pos = Vector(0.059, -0.399, -0.484), angle = Angle(0, 0, 0) },
...
SWEP.Primary.Sound 			= Sound("weapons/laser_rcw/wpn_laserrcw_fire2d.wav")
SWEP.Primary.Recoil 		= 0.01
SWEP.Primary.Damage 		= 20
SWEP.Primary.NumShots 		= 1
SWEP.Primary.Cone 			= 0.038
SWEP.Primary.ClipSize 		= 60
SWEP.Primary.Delay 			= 0.06666667
...
SWEP.IronSightsPos = Vector(-5.738, 2, 2.75)
SWEP.IronSightsAng = Vector(-0.685, -0.42, -1.045)
...
function SWEP:Reload()
	...
	-- When the current clip < full clip and the rest of your ammo > 0, then
		...
		-- Zoom = 0
	self:EmitSound( "weapons/laser_rcw/wpn_laserrcw_reload.wav" )
		self:SetIronsights(false)
		-- Set the ironsight to false
	end
end

local ActIndex = {}		ActIndex["pistol"] 		= ACT_HL2MP_IDLE_PISTOL
	ActIndex["pistol"] 		= ACT_HL2MP_IDLE_PISTOL
	ActIndex["smg"] 			= ACT_HL2MP_IDLE_SMG1
	ActIndex["grenade"] 		= ACT_HL2MP_IDLE_GRENADE
	ActIndex["ar2"] 			= ACT_HL2MP_IDLE_AR2
