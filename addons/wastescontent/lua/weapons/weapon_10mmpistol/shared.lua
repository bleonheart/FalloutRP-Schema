...
if (CLIENT) then
	SWEP.VElements = {
		["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/pistols/10mmpistol.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(-0.058, -0.617, -0.5), angle = Angle(1.023, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
	SWEP.WElements = {
		["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/pistols/10mmpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.993, 1.848, 0.523), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
	}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/pistols/10mmpistol.mdl"
...
SWEP.IronSightsPos = Vector(4.75, -2, 1.95)
SWEP.IronSightsAng = Vector(-1.03, 1, -0.25)
