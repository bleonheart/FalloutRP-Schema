...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/45pistol.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(-0.065, -1, 0.426), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
SWEP.IronSightsPos = Vector(4.38, -2, 2.6)
SWEP.IronSightsAng = Vector(0.35, -0.205, 0)
