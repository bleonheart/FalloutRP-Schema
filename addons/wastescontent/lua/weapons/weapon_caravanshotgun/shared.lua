/**
* Scripted weapon based on Fallout: New Vegas' Caravan Shotgun.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/caravanshotgun.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(-0.008, -1.351, -6.836), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/caravanshotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.593, 1.006, 2.499), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Shotguns/caravanshotgun.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.Right_Arm"] = { scale = Vector(1, 1, 1), pos = Vector(0.446, 0, 0), angle = Angle(0, 0, 0) },
...
SWEP.Primary.Sound 		= Sound("weapons/shotguncaravan/wpn_caravanshotgun.wav")
SWEP.Primary.Reload		= Sound("Weapon_SHOTGUN.Reload")
SWEP.Primary.Recoil		= 5
SWEP.Primary.Damage		= 6.4
SWEP.Primary.NumShots		= 7
SWEP.Primary.Cone			= 0.313
...
SWEP.IronSightsPos = Vector(5.055, -4.001, 1.65)
SWEP.IronSightsAng = Vector(0.586, 0.986, 0)
