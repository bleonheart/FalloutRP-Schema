...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/r91assaultrifle.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(5.664, 1.248, 1.549), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/r91assaultrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.186, 0.739, 2.421), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/AssaultRifles/r91assaultrifle.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.Right_Arm"] = { scale = Vector(1, 1, 1), pos = Vector(2.174, 0.115, -0.232), angle = Angle(0, 0, 0) },
...
SWEP.Primary.Delay 		= 0.092307

SWEP.Primary.ClipSize		= 27					// Size of a clip
...
SWEP.EjectDelay			= 0
SWEP.IronSightsPos = Vector(-5.38, -2, 2.37)
SWEP.IronSightsAng = Vector(0.53, -0.39, -2)
