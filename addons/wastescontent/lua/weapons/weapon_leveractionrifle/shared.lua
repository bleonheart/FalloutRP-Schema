/**
* Scripted weapon based on Fallout 3's Lever-Action Rifle.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/leveractionrifle.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.173, -1.849, -8.796), angle = Angle(0.174, 0.112, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/leveractionrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.672, 1.7, 1.965), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Rifles/leveractionrifle.mdl"
...
SWEP.IronSightsPos = Vector(5.732, -1.2, 3.55)
SWEP.IronSightsAng = Vector(0.138, 0.344, 0)
