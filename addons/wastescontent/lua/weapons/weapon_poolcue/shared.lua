...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/poolcue.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(1.319, 2.767, 19.371), angle = Angle(-180, 17.844, -8.341), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/poolcue.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.151, 1.238, -20.581), angle = Angle(1.157, 0.906, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
