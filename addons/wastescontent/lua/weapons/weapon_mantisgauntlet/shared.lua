/**
* Scripted weapon based on Fallout: New Vegas' Mantis Gauntlet.
*
* @author Kyle James
...
SWEP.Instructions = "Left click or right click to throw a punch."
...
SWEP.VElements = {
	["powerfist"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/mantisgauntlet.mdl", bone = "ValveBiped.Bip01_R_Forearm", rel = "", pos = Vector(11.701, 2.23, 3.085), angle = Angle(-94.746, -90, 0), size = Vector(0.913, 0.913, 0.913), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
		...
		dmginfo:SetDamage( math.random( 30, 30 ) )
