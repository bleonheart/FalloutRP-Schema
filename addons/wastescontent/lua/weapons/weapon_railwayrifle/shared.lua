...
if (CLIENT) then
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/railwayrifle.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(1.101, -2.662, -12.452), angle = Angle(0.174, 0.112, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/railwayrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.378, 1.389, 3.539), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Rifles/railwayrifle.mdl"
...
SWEP.Primary.Sound 			= Sound("weapons/riflerailway/wpn_riflerailway.wav")
...
SWEP.IronSightsPos = Vector(6.567, 0, 2.482)
SWEP.IronSightsAng = Vector(0.138, 0.537, 0)
