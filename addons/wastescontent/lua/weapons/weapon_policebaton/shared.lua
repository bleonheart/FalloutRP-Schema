...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/baton.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(4.091, -0.456, 0.472), angle = Angle(4.218, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/baton.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.801, 1.171, 0.216), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Melee/baton.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["Dummy15"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["Bip01"] = { scale = Vector(1, 1, 1), pos = Vector(1.218, 3.046, 2.74), angle = Angle(-23.757, 10.963, 3.654) },
	...
	if ( trace.Hit ) then
		...
		if (trace.Entity:IsPlayer() or trace.Entity:IsNPC() or string.find(trace.Entity:GetClass(),"prop_ragdoll") or (trace.Entity:GetClass() == "prop_door_rotating")) then
			...
			if (trace.Entity:GetClass() ~= "prop_door_rotating") then 
				self:EmitSound("weapons/bat_baseball_hit_flesh.wav",100,math.random(80,120))
			...
			self.Weapon:SendWeaponAnim(ACT_VM_HITCENTER)
			self.Weapon:EmitSound( self.WallSound,100,math.random(45,65) )
		end
	else
