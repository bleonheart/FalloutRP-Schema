...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/machetegladius.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(3.98, -1.788, -3.822), angle = Angle(-7.252, -89.909, 0.503), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/machetegladius.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.48, 1.629, 5.618), angle = Angle(180, -90.003, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.PrintName		= "Machete Gladius"	 
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Melee/machetegladius.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["Bip01"] = { scale = Vector(1, 1, 1), pos = Vector(-4.636, -7.351, 0.847), angle = Angle(-19.049, 21.788, 0) },
...
SWEP.MissSound 				= Sound("weapons/props_dane/combatknife/slash0.wav")
