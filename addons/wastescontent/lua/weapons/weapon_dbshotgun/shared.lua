/**
* Scripted weapon based on Fallout 3's Double-Barrel Shotgun.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/doublebarrelshotgun.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(-0, -0.173, -3.524), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/doublebarrelshotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.882, 0.773, 1.12), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Shotguns/doublebarrelshotgun.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.Right_Arm"] = { scale = Vector(1, 1, 1), pos = Vector(0.279, 0, 0), angle = Angle(0, 0, 0) },
	["v_weapon.xm1014_Parent"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
SWEP.Spawnable			= true
SWEP.AdminSpawnable		= false

SWEP.Primary.Sound 		= Sound("weapons/shotgundoublebarrel/wpn_dblbarrelshotgun.wav")
...
SWEP.IronSightsPos = Vector(5.185, -0.181, 1.199)
SWEP.IronSightsAng = Vector(1.139, 0.972, -0.84)
