/**
* Scripted weapon based on Fallout: New Vegas' Hunting Rifle.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/huntingrifle.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.328, -3.491, -14.487), angle = Angle(0.174, 0.112, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/huntingrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.172, 1.391, 3.224), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Rifles/huntingrifle.mdl"
...
SWEP.IronSightsPos = Vector(5.875, -0.224, 3.638)
