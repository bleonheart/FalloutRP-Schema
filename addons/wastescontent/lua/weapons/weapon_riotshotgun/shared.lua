...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/riotshotgun.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(-0.253, -0.81, -12.379), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/riotshotgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.123, 0.773, 2.615), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end

SWEP.Base 				= "kermite_base_shotgun_riot"
SWEP.Category			= "Fallout Sweps - Shotguns"
SWEP.HoldType = "ar2"
SWEP.ViewModelFOV = 70
SWEP.ViewModelFlip = true
SWEP.ViewModel = "models/weapons/v_shot_xm1014.mdl"
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Shotguns/riotshotgun.mdl"
...
SWEP.Primary.Sound 		= Sound("weapons/shotgunriot/wpn_riotshotgun.wav")
...
SWEP.IronSightsPos = Vector(4.949, 0.453, 1.62)
SWEP.IronSightsAng = Vector(0.208, 0.889, 0)
