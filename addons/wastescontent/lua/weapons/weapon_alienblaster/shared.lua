/**
* Scripted weapon based on Fallout: New Vegas' Alien Blaster.
*
* @author Kyle James
...
local LaserHitImpact = function(attacker, tr, dmginfo)
	...
	util.Effect("effect_fo3_alienblasterhit", laserhit)
...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Alien Weapons/alienblaster.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.266, -1.676, -1.237), angle = Angle(3.362, 0.72, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Alien Weapons/alienblaster.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.113, 2.269, 1.748), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Alien Weapons/alienblaster.mdl"
...
SWEP.IronSightsPos = Vector(2.601, -2.5, 4.374)
