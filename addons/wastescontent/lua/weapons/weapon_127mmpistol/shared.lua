/**
* Scripted weapon based on Fallout: New Vegas' 12.7mm Pistol.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/127mmpistol.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.185, -2.004, -1.033), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/127mmpistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.985, 1.537, 1.651), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/127mmpistol.mdl"
...
SWEP.Primary.Sound 			= Sound("weapons/9mm_smg/wpn_9mm.wav")
...
SWEP.IronSightsPos = Vector(4.702, -2, 1.519)
SWEP.IronSightsAng = Vector(-0.141, -0.071, -0.964)
