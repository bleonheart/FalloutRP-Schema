/**
* Scripted weapon based on Fallout: New Vegas' 9mm Submachine Gun.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/9mmsmg.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-2.32, -8.322, 2.928), angle = Angle(-169.946, -153.732, -1.329), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/9mmsmg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.001, 1.402, 1.605), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/SMGs/9mmsmg.mdl"
...
SWEP.IronSightsPos = Vector(5.62, -2.725, 2.246)
SWEP.IronSightsAng = Vector(-1.119, 2.18, -2.467)
