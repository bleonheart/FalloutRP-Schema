/**
* Scripted weapon based on Fallout: New Vegas' 10mm Pistol with the 10mm Pistol Silencer modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/pistols/10mmpistolsilenced.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(-0.224, -0.805, -1.5), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/pistols/10mmpistolsilenced.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.721, 1.848, 0.097), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/pistols/10mmpistolsilenced.mdl"
...
SWEP.Primary.Sound 		= Sound("weapons/pistol_10mm/wpn_pistol10mm_silenced.wav")
...
SWEP.IronSightsPos = Vector(4.431, -2, 2.048)
SWEP.IronSightsAng = Vector(-0.937, -0.208, -0)
