...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/chineseassaultrifle.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(5.765, 1.281, 1.434), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/chineseassaultrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.354, 1.662, 2.176), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/AssaultRifles/chineseassaultrifle.mdl"
...
SWEP.Primary.Sound 		= Sound("weapons/riflecar/wpn_car.wav")
...
SWEP.RunSightsAng   = Vector (-20.0824, -21, -1)
SWEP.IronSightsPos = Vector(-5.52, -2, 1.1)
SWEP.IronSightsAng = Vector(-0.143, -0.445, -1.4)
