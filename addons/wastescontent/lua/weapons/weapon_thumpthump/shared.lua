...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/grenaderifleunique.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(2.065, -2.097, -8.544), angle = Angle(5.047, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["launcher"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/grenaderifleunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.545, 0.435, 1.654), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.PrintName				= "Thump-Thump"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/explosives/grenaderifleunique.mdl"
