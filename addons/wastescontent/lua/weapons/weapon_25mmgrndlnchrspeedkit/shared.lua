/**
* Scripted weapon based on Fallout: New Vegas' Grenade Machine Gun with the Grenade MG High-Speed Kit.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["bigweapons"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Heavy Weapons/25mmgrndlnchrhispeedkit.mdl", bone = "ValveBiped.Bip01", rel = "", pos = Vector(-3.001, -25.887, -8.513), angle = Angle(0.003, 90, 90.001), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["bigweapons"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Heavy Weapons/25mmgrndlnchrhispeedkit.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-10.193, -0.224, -9.91), angle = Angle(-99.802, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.PrintName				= "Grenade Machinegun (w/ High-Speed Kit)"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Heavy Weapons/25mmgrndlnchrhispeedkit.mdl"
...
SWEP.Primary.Ammo			= "25mmGrenade"				

SWEP.Secondary.IronFOV			= 70		-- How much you 'zoom' in. Less is more! 	
SWEP.Primary.Round 			= ("halo_launched_ex25")	--NAME OF ENTITY GOES HERE
...
SWEP.IronSightsPos = Vector(0.865, -5.592, 0.55)
SWEP.IronSightsAng = Vector(7.44, 5.236, 0)
