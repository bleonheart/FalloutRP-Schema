...
if (CLIENT) then
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/huntingrifleext.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(0.8, -2.5, -8), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/huntingrifleext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.869, 1.391, 3.48), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Rifles/huntingrifleext.mdl"
...
SWEP.IronSightsPos = Vector(6.35, 0, 2.7)
SWEP.IronSightsAng = Vector(0, 0.1, 0.5)
