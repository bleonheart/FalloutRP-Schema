...
SWEP.PrintName				= "Plasma Grenade"		-- Weapon name (Shown on HUD)	
...
SWEP.WorldModel 		= "models/halokiller38/fallout/weapons/explosives/plasmagrenade.mdl"
...
SWEP.Primary.Ammo			= "PlasmaGrenade"				
-- pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, AirboatGun
-- Pistol, buckshot, and slam always ricochet. Use AirboatGun for a metal peircing shotgun slug

SWEP.Primary.Round 			= ("halo_thrown_plasma")	--NAME OF ENTITY GOES HERE
...
SWEP.VElements = {
	["grenade"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/plasmagrenade.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.841, -2.961, 0), angle = Angle(0.228, -9.11, 90.253), size = Vector(0.786, 0.786, 0.786), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["grenade"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/plasmagrenade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.144, 1.847, 0.727), angle = Angle(180, 180, 0), size = Vector(1.302, 1.302, 1.302), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
