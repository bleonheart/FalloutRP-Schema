...
if ( CLIENT ) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/spikedknuckles.mdl", bone = "Bip01 R Hand", rel = "", pos = Vector(3.22, -0.232, 0.584), angle = Angle(180, 90.004, -180), size = Vector(1.202, 1.202, 1.202), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/spikedknuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.532, 0.87, 0.551), angle = Angle(-180, 90, -180), size = Vector(1.338, 1.338, 1.338), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
	SWEP.Slot			= 0					 
	SWEP.SlotPos		= 1
	SWEP.DrawAmmo		= false					 
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Melee/spikedknuckles.mdl"
