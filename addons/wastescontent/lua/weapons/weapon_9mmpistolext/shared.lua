/**
* Scripted weapon based on Fallout: New Vegas' 9mm Pistol with the 9mm Pistol Extended Mags modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/9mmextclip.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.19, -1.382, 1.355), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/9mmextclip.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.503, 1.679, 0.236), angle = Angle(180, -90, 1), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/9mmextclip.mdl"
...
SWEP.IronSightsPos = Vector(4.649, -1, 3.013)
SWEP.IronSightsAng = Vector(0.207, -0.208, -0.76)
