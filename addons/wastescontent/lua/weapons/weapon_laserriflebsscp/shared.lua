/**
* Scripted weapon based on Fallout: New Vegas' Laser Rifle with the Laser Rifle Beam Splitter and Laser Rifle Scope modifications.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserriflescopebs.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(7.921, 1.978, 2.443), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laserriflescopebs.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.456, 0.764, 3.308), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end

SWEP.PrintName			= "Laser Rifle (Beam Splitter w/ Scope)"					// 'Nice' Weapon name (Shown on HUD)	
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Energy Weapons/laserriflescopebs.mdl"
...
SWEP.Primary.Delay				= 0.323		-- This is in Rounds Per Minute
...
SWEP.Primary.Damage		= 14.3	--base damage per bullet
