...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/assaultcarbinesilencer.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(4.631, 1.432, 1.85), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/assaultcarbinesilencer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.448, 0.777, 2.404), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end

SWEP.Base 				= "kermite_base_rifle"
SWEP.Category			= "Fallout Sweps - Assault Rifles"
SWEP.Spawnable			= true
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/AssaultRifles/assaultcarbinesilencer.mdl"
...
SWEP.Primary.Sound 		= Sound("weapons/rifleassaultcarbine/wpn_rifleassaultsilenced.wav")
SWEP.Primary.Recoil			= .75
SWEP.Primary.Damage			= 19
SWEP.Primary.NumShots		= 1
SWEP.Primary.Cone			= 0.001 
SWEP.Primary.Delay 			= 0.070588
...
SWEP.IronSightsPos = Vector(-5.485, -2, 2.50)
SWEP.IronSightsAng = Vector(-0.54, -0.325, -1.831)
