/**
* Scripted weapon based on Fallout: New Vegas' LAER.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laer.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(0.555, 1.521, 1.963), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Energy Weapons/laer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.565, 2, 3.029), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Energy Weapons/laer.mdl"
...
SWEP.EjectDelay			= 0
/*-------------------------------------------------------*/
SWEP.MuzzleEffect			= "fo3_muzzle_laer" -- This is an extra muzzleflash effect
SWEP.MuzzleAttachment		= "1" -- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment	= "2" -- Should be "2" for CSS models or "1" for hl2 models

SWEP.RunSightsPos  = Vector (-2.6657, 0, 3.5)
SWEP.RunSightsAng   = Vector (-20.0824, -20.5693, 0)
SWEP.IronSightsPos = Vector(-5.954, -1, 1.725)
...
function SWEP:CSShootBullet(dmg, recoil, numbul, cone)
	...
	bullet.TracerName 	= "effect_fo3_laer"
