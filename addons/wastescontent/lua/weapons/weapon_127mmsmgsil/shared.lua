...
if (CLIENT) then
SWEP.VElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/127smgsilencer.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-5.569, -15.417, 1.957), angle = Angle(-169.946, -153.732, -1.329), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/127smgsilencer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-4.719, 1.402, 1.605), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end

SWEP.Base 				= "kermite_base_smg"
SWEP.Category			= "Fallout Sweps - Sub-Machine Guns"
SWEP.Spawnable			= true
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/SMGs/127smgsilencer.mdl"
...
SWEP.IronSightsPos = Vector(6.15, 1, 0.984)
SWEP.IronSightsAng = Vector(-1.225, 2.79, -2)
