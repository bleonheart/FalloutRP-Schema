/**
* Scripted weapon based on Fallout: New Vegas' Light Machine Gun.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["heavyweapons"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/lightmachinegun.mdl", bone = "v_weapon.famas", rel = "", pos = Vector(0.243, 4.234, 2.286), angle = Angle(-180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["heavyweapons"] = { type = "Model", model = "models/halokiller38/fallout/weapons/heavy weapons/lightmachinegun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.3, 0.796, 2.496), angle = Angle(180, -90, 7.007), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/heavy weapons/lightmachinegun.mdl"
