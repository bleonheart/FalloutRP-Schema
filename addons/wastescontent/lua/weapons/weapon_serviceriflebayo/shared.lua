/**
* Scripted weapon based on Fallout: New Vegas' Service Rifle with the Service Rifle Bayonet modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/battleriflebayo.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(3.493, 1.613, 1.269), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/battleriflebayo.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.898, 0.56, 2.013), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/AssaultRifles/battleriflebayo.mdl"
...
SWEP.IronSightsPos = Vector(-5.08, -4, 2.15)
SWEP.IronSightsAng = Vector(0.507, -0.19, -0.893)
