...
if (CLIENT) then
SWEP.VElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/45smg.mdl", bone = "v_weapon.Right_Hand", rel = "", pos = Vector(-2.464, -8.714, 1.634), angle = Angle(-169.946, -153.732, -1.329), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["smg"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/SMGs/45smg.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.509, 1.873, 0.512), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/SMGs/45smg.mdl"
...
SWEP.Primary.Sound 		= Sound("weapons/45smg/wpn_45smg.wav")
...
SWEP.RunSightsPos  = Vector (-2.66, 0, 3.5)
SWEP.RunSightsAng   = Vector (-20.0824, -20.5693, 0)
SWEP.IronSightsPos = Vector(6.565, 4, 2.3)
SWEP.IronSightsAng = Vector(-1.95, 2.237, -2.467)
