/**
* Scripted weapon based on Fallout 3's Alien Atomizer.
*
* @author Kyle James
...
local LaserHitImpact = function(attacker, tr, dmginfo)
	...
	util.Effect("effect_fo3_alienatomizerhit", laserhit)
...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Alien Weapons/alienatomizer.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.187, -1.953, -4.784), angle = Angle(1.541, -1.063, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Alien Weapons/alienatomizer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.896, 2.269, 1.748), angle = Angle(180, -90, 5.094), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Alien Weapons/alienatomizer.mdl"
SWEP.ShowViewModel = true
SWEP.ShowWorldModel = false
SWEP.ViewModelBoneMods = {
	["v_weapon.FIVESEVEN_TRIGGER"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	...
	["v_weapon.FIVESEVEN_CLIP"] = { scale = Vector(0.009, 0.009, 0.009), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}

SWEP.EjectDelay				= 0

SWEP.Primary.Sound 		= Sound("weapons/alienblaster/wpn_alienblaster_fire_2d.wav")
...
SWEP.Primary.Ammo			= "AlienPowerCell"
...
SWEP.EjectDelay			= 0
/*-------------------------------------------------------*/
SWEP.MuzzleEffect			= "fo3_muzzle_alienatomizer" -- This is an extra muzzleflash effect
SWEP.MuzzleAttachment		= "1" -- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment	= "2" -- Should be "2" for CSS models or "1" for hl2 models

SWEP.IronSightsPos = Vector(4.51, -1.5, 1.01)
SWEP.IronSightsAng = Vector(0.824, 1.731, -1.175)
...
function SWEP:CSShootBullet(dmg, recoil, numbul, cone)
	...
	bullet.TracerName 	= "effect_fo3_atomizerbeam"
