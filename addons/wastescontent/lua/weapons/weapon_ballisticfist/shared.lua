/**
* Scripted weapon based on Fallout: New Vegas' Ballistic Fist.
*
* @author Kyle James
...
SWEP.Purpose = "A powerful unarmed weapon designed to pack a powerful punch."
SWEP.Instructions = "Left or right click to punch."
...
SWEP.WorldModel = "models/halokiller38/fallout/weapons/melee/ballisticfist.mdl"
...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
		...
		dmginfo:SetDamage( math.random( 80, 80 ) )
