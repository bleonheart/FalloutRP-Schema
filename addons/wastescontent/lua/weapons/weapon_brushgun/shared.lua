/**
* Scripted weapon based on Fallout: New Vegas' Brush Gun.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/brushgun.mdl", bone = "v_weapon.awm_parent", rel = "", pos = Vector(-0.01, -2.32, -5.868), angle = Angle(0.174, 0.112, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Rifles/brushgun.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.467, 1.314, 2.119), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Rifles/brushgun.mdl"
...
SWEP.IronSightsPos = Vector(5.658, -1.374, 3.535)
SWEP.IronSightsAng = Vector(0, 0.284, 0)
