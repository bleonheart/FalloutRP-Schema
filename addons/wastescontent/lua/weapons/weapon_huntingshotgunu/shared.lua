/**
* Scripted weapon based on Fallout: New Vegas' Dinner Bell.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/huntingshotgununique.mdl", bone = "v_weapon.M3_PARENT", rel = "", pos = Vector(-0.427, -0.322, -9.31), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/huntingshotgununique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-5.119, 1.016, 1.886), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Shotguns/huntingshotgununique.mdl"
...
SWEP.IronSightsPos = Vector(5.537, -1.093, 2.52)
