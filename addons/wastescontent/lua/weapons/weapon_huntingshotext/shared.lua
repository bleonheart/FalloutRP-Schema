/**
* Scripted weapon based on Fallout: New Vegas' Hunting Shotgun with the Hunting Shotgun Long Tube modification.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["element_name"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/huntingshotgunext.mdl", bone = "v_weapon.M3_PARENT", rel = "", pos = Vector(-0.427, -0.322, -9.247), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["rifle"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Shotguns/huntingshotgunext.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6.402, 0.773, 2.331), angle = Angle(0, 90, -172.67), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Shotguns/huntingshotgunext.mdl"
