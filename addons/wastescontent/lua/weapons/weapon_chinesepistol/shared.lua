...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/chinesepistol.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.082, -1.024, 0.034), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/chinesepistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.256, 1.73, 0.63), angle = Angle(180, -90, 1), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/chinesepistol.mdl"
...
SWEP.Primary.Sound 			= Sound("weapons/pistolchinese/wpn_chinesepistol.wav")
...
SWEP.IronSightsPos = Vector(4.57, -1.75, 1.5)
SWEP.IronSightsAng = Vector(1.32, -0.23, 0)
