/**
* Scripted weapon based on Fallout: New Vegas' Assault Carbine.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/assaultcarbine.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(5.921, 1.432, 1.85), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/assaultcarbine.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.714, 0.56, 2.013), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/AssaultRifles/assaultcarbine.mdl"
...
SWEP.IronSightsPos = Vector(-5.49, -2, 2.460)
SWEP.IronSightsAng = Vector(-0.581, -0.247, -1.032)
