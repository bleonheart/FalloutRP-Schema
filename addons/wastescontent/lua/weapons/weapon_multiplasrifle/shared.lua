...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/multiplasrifle.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(8.1, -2.668, -5.718), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/multiplasrifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.44, 0.764, -5.682), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Plasma Weapons/multiplasrifle.mdl"
...
SWEP.Primary.Sound 			= Sound("weapons/riflemultiplas/wpn_multiplasrifle.wav")
...
SWEP.IronSightsPos = Vector(-5.897, 0, 2.003)
SWEP.IronSightsAng = Vector(-1.4, -0.167, -1.109)
...
function SWEP:CSShootBullet(dmg, recoil, numbul, cone)
	...
	bullet.TracerName 	= "effect_fo3_plasmahit"
