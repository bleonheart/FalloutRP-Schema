...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmarifle.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(8.548, 0.629, -0.877), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmarifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.673, 0.764, -0.876), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Plasma Weapons/plasmarifle.mdl"
...
SWEP.IronSightsPos = Vector(-5.761, -1.5, 2.003)
SWEP.IronSightsAng = Vector(-1.42, -0.21, -1.109)
