...
if (CLIENT) then
SWEP.VElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/silenced22pistol.mdl", bone = "v_weapon.FIVESEVEN_PARENT", rel = "", pos = Vector(0.09, -0.61, 0.763), angle = Angle(0, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["pistol"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Pistols/silenced22pistol.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.503, 1.679, 0.043), angle = Angle(180, -90, 1), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/Pistols/silenced22pistol.mdl"
...
SWEP.Primary.Sound 		= Sound("weapons/pistol_22mm/wpn_silenced_22_pistol.wav")
...
SWEP.IronSightsPos = Vector(4.552, -1, 3.196)
SWEP.IronSightsAng = Vector(-0.004, -0.065, -0.76)
