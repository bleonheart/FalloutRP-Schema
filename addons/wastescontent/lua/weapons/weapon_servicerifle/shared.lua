/**
* Scripted weapon based on Fallout: New Vegas' Service Rifle.
*
* @author Kyle James
...
if (CLIENT) then
SWEP.VElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/battlerifle.mdl", bone = "v_weapon.Right_Arm", rel = "", pos = Vector(5.376, 1.37, 1.516), angle = Angle(152, -90.296, 1.475), size = Vector(1.001, 1.001, 1.001), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["alien"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/AssaultRifles/battlerifle.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.714, 0.56, 2.013), angle = Angle(180, -90.001, 6.765), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.WorldModel = "models/Halokiller38/fallout/weapons/AssaultRifles/battlerifle.mdl"
...
SWEP.IronSightsPos = Vector(-5.4, -2, 2.29)
SWEP.IronSightsAng = Vector(-0.443, -0.322, -0.893)
