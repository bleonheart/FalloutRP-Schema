...
SWEP.Contact				= ""
SWEP.Purpose				= ""
SWEP.Instructions				= "TELLMEANOTHER"
...
SWEP.Primary.Round 			= ("halo_thrown_pulse")	--NAME OF ENTITY GOES HERE
...
SWEP.VElements = {
	["grenade"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/stungrenade.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(0.441, -2.861, 0), angle = Angle(0.228, -9.11, 90.253), size = Vector(0.786, 0.786, 0.786), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["grenade"] = { type = "Model", model = "models/halokiller38/fallout/weapons/explosives/stungrenade.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.144, 1.847, 0.727), angle = Angle(180, 180, 0), size = Vector(1.302, 1.302, 1.302), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
