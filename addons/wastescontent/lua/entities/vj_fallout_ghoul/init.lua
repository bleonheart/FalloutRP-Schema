...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/ghoul/npc_ghoul_foot_01.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_attack_01.mp3",
	"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_attack_02.mp3",
	"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_attack_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_attack_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_death_01.mp3",
	"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_awarevox_01.mp3",
	"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_awarevox_02.mp3",
	"fosounds/vj_forpnpcs/ghoul/npc_feralghoul_awarevox_03.mp3"}
...
ENT.AnimTbl_Flinch = {"specialidle_hittorso",
	"specialidle_hitlegright",
	"specialidle_hitlegleft",
	"specialidle_hithead",
	"specialidle_hitarmright",
	"specialidle_hitarmleft"} -- If it uses normal based animation, use this
