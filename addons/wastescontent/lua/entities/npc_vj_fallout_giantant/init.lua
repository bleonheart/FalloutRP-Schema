...
ENT.SoundTbl_FootStep = {"vj_fallout_monsters/foot/ant_foot_l01.mp3","vj_fallout_monsters/foot/ant_foot_l02.mp3","vj_fallout_monsters/foot/ant_foot_r01.mp3","vj_fallout_monsters/foot/ant_foot_r02.mp3"}
ENT.SoundTbl_MeleeAttack = {"vj_fallout_monsters/ant_attack01.mp3","vj_fallout_monsters/ant_attack02.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"vj_fallout_monsters/ant_attack03.mp3"}
ENT.SoundTbl_Death = {"vj_fallout_monsters/ant_death01.mp3","vj_fallout_monsters/ant_death02.mp3"}
ENT.SoundTbl_Idle = {"vj_fallout_monsters/ant_idle01.mp3","vj_fallout_monsters/ant_idle02.mp3","vj_fallout_monsters/ant_idle03.mp3","vj_fallout_monsters/ant_injured01.mp3","vj_fallout_monsters/ant_injured02.mp3"}
...
ENT.AnimTbl_Flinch = {"Mtspecialidle_Hithead","Mtspecialidle_Knockdownfaceleft","Mtspecialidle_Knockdownfaceright"} -- If it uses normal based animation, use this
