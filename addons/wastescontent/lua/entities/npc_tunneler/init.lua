...
-----------------------------------------------*/
ENT.Model = {"models/fallout/tunneler.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 130
...
ENT.SoundTbl_FootStep = {"streettrog/foot/trog_foot_l01.mp3","streettrog/foot/trog_foot_l02.mp3","streettrog/foot/trog_foot_l03.mp3","streettrog/foot/trog_foot_r01.mp3","streettrog/foot/trog_foot_r02.mp3","streettrog/foot/trog_foot_r03.mp3"}
ENT.SoundTbl_MeleeAttack = {"traumaharness/attack01.wav","traumaharness/attack02.wav","traumaharness/attack03.wav","traumaharness/attack04.wav"}
ENT.SoundTbl_MeleeAttackMiss = {"traumaharness/hit01.wav","traumaharness/hit02.wav","traumaharness/hit03.wav","traumaharness/hit04.wav"}
ENT.SoundTbl_Death = {"traumaharness/death01.wav","traumaharness/death02.wav","traumaharness/death03.wav"}
ENT.SoundTbl_Idle = {""}
