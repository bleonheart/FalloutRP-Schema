...
ENT.SoundTbl_FootStep = {"vj_fallout_monsters/foot/nightstalker_foot01.mp3","vj_fallout_monsters/foot/nightstalker_foot02.mp3","vj_fallout_monsters/foot/nightstalker_foot03.mp3","vj_fallout_monsters/foot/nightstalker_foot04.mp3","vj_fallout_monsters/foot/nightstalker_foot05.mp3","vj_fallout_monsters/foot/nightstalker_foot06.mp3"}
ENT.SoundTbl_MeleeAttack = {"vj_fallout_monsters/nightstalker_atk01.mp3","vj_fallout_monsters/nightstalker_atk02.mp3","vj_fallout_monsters/nightstalker_atk03.mp3","vj_fallout_monsters/nightstalker_atk04.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"vj_fallout_monsters/nightstalker_atk05.mp3","vj_fallout_monsters/nightstalker_atk06.mp3"}
ENT.SoundTbl_Death = {"vj_fallout_monsters/nightstalker_death01.mp3","vj_fallout_monsters/nightstalker_death02.mp3","vj_fallout_monsters/nightstalker_death03.mp3","vj_fallout_monsters/nightstalker_death04.mp3"}
ENT.SoundTbl_Idle = {"vj_fallout_monsters/nightstalker_growl01.mp3","vj_fallout_monsters/nightstalker_growl02.mp3","vj_fallout_monsters/nightstalker_growl03.mp3","vj_fallout_monsters/nightstalker_growl04.mp3","vj_fallout_monsters/nightstalker_growl05.mp3","vj_fallout_monsters/nightstalker_growl06.mp3"}
...
ENT.AnimTbl_Flinch = {"H2hattackright_Midbite","H2hequip","H2hunequip"} -- If it uses normal based animation, use this
