...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_footfront_02.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_attackforward_01.mp3",
	"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_attackforward_02.mp3",
	"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_attackforward_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_attackforward_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_death_01.mp3",
	"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_idlebreathe_01.mp3",
	"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_idlebreathe_02.mp3",
	"fosounds/vj_forpnpcs/yaoguai/npc_yaoguai_idlebreathe_03.mp3"}
...
ENT.AnimTbl_Flinch = {"Mtspecialidle_Hithead",
	"Mtspecialidle_Hitleftarm",
	"Mtspecialidle_Hitleftleg",
	"Mtspecialidle_hittorso"} -- If it uses normal based animation, use this
...
function ENT:MultipleMeleeAttacks()
	...
	if EnemyDistance > 0 and EnemyDistance < 120 then
