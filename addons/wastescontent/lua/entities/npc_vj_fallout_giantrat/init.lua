...
-----------------------------------------------*/
ENT.Model = {"models/fallout/giantrat.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 200
...
ENT.SoundTbl_FootStep = {"vj_fallout_monsters/foot/giantrat_foot_l01.mp3","vj_fallout_monsters/foot/giantrat_foot_l02.mp3","vj_fallout_monsters/foot/giantrat_foot_l03.mp3","vj_fallout_monsters/foot/giantrat_foot_l04.mp3","vj_fallout_monsters/foot/giantrat_foot_r01.mp3","vj_fallout_monsters/foot/giantrat_foot_r02.mp3"}
ENT.SoundTbl_MeleeAttack = {"vj_fallout_monsters/giantrat_attack01.mp3","vj_fallout_monsters/giantrat_attack02.mp3","vj_fallout_monsters/giantrat_attack2_01.mp3","vj_fallout_monsters/giantrat_attack2_02.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"vj_fallout_monsters/giantrat_attack2_03.mp3","vj_fallout_monsters/giantrat_attack2_04.mp3","vj_fallout_monsters/giantrat_attack2_05.mp3","vj_fallout_monsters/giantrat_attack03.mp3"}
ENT.SoundTbl_Death = {"vj_fallout_monsters/giantrat_pant05.mp3"}
ENT.SoundTbl_Idle = {"vj_fallout_monsters/giantrat_battlecry01.mp3","vj_fallout_monsters/giantrat_battlecry02.mp3","vj_fallout_monsters/giantrat_hiss04.mp3","vj_fallout_monsters/giantrat_idle_chirp.mp3","vj_fallout_monsters/giantrat_idle_dig.mp3"}
...
ENT.AnimTbl_Flinch = {"Hitreaction_Head","Hitreaction_Leftleg","Hitreaction_Rightleg"} -- If it uses normal based animation, use this
