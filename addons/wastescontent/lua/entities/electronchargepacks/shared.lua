ENT.Type 			= "anim"
ENT.Base 			= "base_anim"
ENT.PrintName		= "Electron Charge Packs"
...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("ElectronChargePacks")
...
function ENT:Initialize()
	...
	local model = ("models/maxibammo/electronchargepack.mdl")
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		...
		activator:GiveAmmo(50, "ElectronChargePack")
		self.Entity:Remove()
	end
