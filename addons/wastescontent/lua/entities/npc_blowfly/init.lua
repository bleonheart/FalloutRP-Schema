...
ENT.StartHealth = GetConVarNumber("vj_blowfly_h")
...
ENT.Immune_Dissolve = true
	-- Relationships ---------------------------------------------------------------------------------------------------------------------------------------------
ENT.VJ_NPC_Class = {"CLASS_BLOWFLY"} -- NPCs with the same class with be allied to each other
...
ENT.LeapDistance = 60 -- The distance of the leap, for example if it is set to 500, when the SNPC is 500 Unit away, it will jump
...
ENT.MeleeAttackDamage = GetConVarNumber("vj_blowfly_d")
ENT.MeleeAttackDamageType = DMG_SLASH
ENT.AnimTbl_MeleeAttack = {"1hpattackright","specialidle_hit","specialidle_cleanhead"}
...
ENT.SoundTbl_Idle = {"blowfly/blowfly_idle_lp.wav"}
ENT.SoundTbl_Breath = {""}
ENT.SoundTbl_CombatIdle = {"blowfly/blowfly_injured01.mp3","blowfly/blowfly_injured02.mp3"}
ENT.SoundTbl_Alert = {""}
ENT.SoundTbl_BeforeMeleeAttack = {"blowfly/blowfly_attack01.mp3"}
ENT.SoundTbl_MeleeAttack = {"blowfly/blowfly_attackdart01.mp3"}
ENT.SoundTbl_Pain = {""}
ENT.SoundTbl_OnKilledEnemy = {""}
ENT.SoundTbl_Death = {"blowfly/blowfly_death01.mp3","blowfly/blowfly_death02.mp3"}
