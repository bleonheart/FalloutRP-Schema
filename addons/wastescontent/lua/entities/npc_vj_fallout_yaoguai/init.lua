...
ENT.SoundTbl_FootStep = {"vj_fallout_monsters/foot/yaoguai_footfront_l.mp3","vj_fallout_monsters/foot/yaoguai_footfront_r.mp3","vj_fallout_monsters/foot/yaoguai_footrear_l.mp3","vj_fallout_monsters/foot/yaoguai_footrear_r.mp3"}
ENT.SoundTbl_MeleeAttack = {"vj_fallout_monsters/yaoguai_attackforward02.mp3","vj_fallout_monsters/yaoguai_attackforward03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"vj_fallout_monsters/yaoguai_attackforward02.mp3","vj_fallout_monsters/yaoguai_attackswing01.mp3"}
ENT.SoundTbl_Death = {"vj_fallout_monsters/yaoguai_death01.mp3","vj_fallout_monsters/yaoguai_death02.mp3"}
ENT.SoundTbl_Idle = {"vj_fallout_monsters/yaoguai_idlebreathe01.mp3","vj_fallout_monsters/yaoguai_idlebreathe02.mp3","vj_fallout_monsters/yaoguai_idlebreathe04.mp3"}
...
ENT.AnimTbl_Flinch = {"Mtspecialidle_Hithead","Mtspecialidle_Hitleftarm","Mtspecialidle_Hitleftleg","Mtspecialidle_hittorso"} -- If it uses normal based animation, use this
