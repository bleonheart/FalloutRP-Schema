...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("20GaugeAmmo")
...
function ENT:Initialize()
	...
	local model = ("models/maxibammo/buckshot.mdl")
