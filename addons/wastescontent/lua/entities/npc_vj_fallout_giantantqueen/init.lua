...
ENT.SoundTbl_FootStep = {"vj_fallout_monsters/foot/antqueen_foot_l01.mp3","vj_fallout_monsters/foot/antqueen_foot_l02.mp3","vj_fallout_monsters/foot/antqueen_foot_r01.mp3","vj_fallout_monsters/foot/antqueen_foot_r02.mp3","vj_fallout_monsters/foot/antqueen_foot_run_l01.mp3"}
ENT.SoundTbl_MeleeAttack = {"vj_fallout_monsters/antqueen_attack_spit.mp3","vj_fallout_monsters/antqueen_attack01.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"vj_fallout_monsters/antqueen_attack02.mp3","vj_fallout_monsters/antqueen_attack03.mp3"}
ENT.SoundTbl_Death = {"vj_fallout_monsters/antqueen_death.mp3"}
ENT.SoundTbl_Idle = {"vj_fallout_monsters/antqueen_idle01.mp3","vj_fallout_monsters/antqueen_idle02.mp3","vj_fallout_monsters/antqueen_idle03.mp3"}
...
ENT.AnimTbl_Flinch = {"Specialidle_Getup","Specialidle_Help","Specialidle_Sack"} -- If it uses normal based animation, use this
