...
ENT.SoundTbl_MeleeAttack = {"sporeplant/sporeplant_vomit01.mp3","sporeplant/sporeplant_vomit02.mp3","sporeplant/sporeplant_vomit03.mp3","sporeplant/sporeplant_vomit04.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"sporeplant/sporeplant_fire_3d01.mp3","sporeplant/sporeplant_fire_3d02.mp3","sporeplant/sporeplant_fire_3d03.mp3","sporeplant/sporeplant_fire_3d04.mp3","sporeplant/sporeplant_fire_3d05.mp3","sporeplant/sporeplant_fire_3d06.mp3"}
ENT.SoundTbl_Death = {"sporeplant/sporeplant_death01.mp3","sporeplant/sporeplant_death02.mp3","sporeplant/sporeplant_death03.mp3"}
ENT.SoundTbl_Idle = {"sporeplant/sporeplant_mvmt_lp.wav","sporeplant/sporeplant_mvmt01.mp3","sporeplant/sporeplant_mvmt02.mp3","sporeplant/sporeplant_mvmt03.mp3","sporeplant/sporeplant_mvmt04.mp3","sporeplant/sporeplant_mvmt05.mp3"}
ENT.SoundTbl_CombatIdle = {"sporeplant/sporeplant_scream01.mp3","sporeplant/sporeplant_scream02.mp3","sporeplant/sporeplant_scream03.mp3","sporeplant/sporeplant_scream04.mp3","sporeplant/sporeplant_scream05.mp3","sporeplant/sporeplant_scream06.mp3"}
...
function ENT:CustomOnInitialize()
	self:SetCollisionBounds(Vector(50, 35, 80), Vector(-40, -40, 0))
	self:SetSkin(1)
end
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
