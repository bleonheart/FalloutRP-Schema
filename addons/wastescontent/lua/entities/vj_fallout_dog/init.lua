...
ENT.Model = {"models/fallout/dogvicious.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 200
...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/dogs/npc_dog_foot.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/dogs/npc_dog_attackmid_01.mp3",
	"fosounds/vj_forpnpcs/dogs/npc_dog_attackmid_02.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/dogs/npc_dog_attackmid_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/dogs/npc_dog_death_01.mp3",
	"fosounds/vj_forpnpcs/dogs/npc_dog_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/dogs/npc_dog_bark_01.mp3",
	"fosounds/vj_forpnpcs/dogs/npc_dog_bark_02.mp3",
	"fosounds/vj_forpnpcs/dogs/npc_dog_bark_03.mp3",
	"fosounds/vj_forpnpcs/dogs/npc_dog_cheybark.mp3"}
...
ENT.AnimTbl_Flinch = {"mtspecialidle_hitright",
	"mtspecialidle_hitleft",
	"mtspecialidle_hithead"} -- If it uses normal based animation, use this
