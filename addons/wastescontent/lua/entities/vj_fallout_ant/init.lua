...
ENT.Model = {"models/fallout/giantant.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you wgiantant
ENT.StartHealth = 200
...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/giantant/npc_ant_foot_01.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/giantant/npc_ant_attack_01.mp3",
	"fosounds/vj_forpnpcs/giantant/npc_ant_attack_02.mp3",
	"fosounds/vj_forpnpcs/giantant/npc_ant_attack_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/giantant/npc_ant_attack_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/giantant/npc_ant_death_01.mp3",
	"fosounds/vj_forpnpcs/giantant/npc_ant_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/giantant/npc_ant_mumble_01.mp3",
	"fosounds/vj_forpnpcs/giantant/npc_ant_mumble_02.mp3",
	"fosounds/vj_forpnpcs/giantant/npc_ant_mumble_03.mp3"}
...
ENT.AnimTbl_Flinch = {"Mtspecialidle_Hithead",
	"Mtspecialidle_Knockdownfaceleft",
	"Mtspecialidle_Knockdownfaceright"}
