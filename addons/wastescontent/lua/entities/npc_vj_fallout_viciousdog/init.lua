...
ENT.SoundTbl_MeleeAttack = {"vj_fallout_dog/attack1.wav","vj_fallout_dog/attack2.wav"}
ENT.SoundTbl_MeleeAttackMiss = {"vj_fallout_dog/attack1.wav","vj_fallout_dog/attack2.wav"}
ENT.SoundTbl_Death = {"vj_fallout_dog/die1.wav","vj_fallout_dog/die2.wav"}
...
ENT.AnimTbl_Flinch = {"Mtspecialidle_Hithead","Mtspecialidle_Hitleft","Mtspecialidle_Hitright"} -- If it uses normal based animation, use this
