...
-----------------------------------------------*/
ENT.Model = {"models/fallout/mantis_nymph.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 55
...
ENT.SoundTbl_FootStep = {"mantis/foot/fst_mantis_l01.mp3","mantis/foot/fst_mantis_l02.mp3","mantis/foot/fst_mantis_l03.mp3","mantis/foot/fst_mantis_l04.mp3","mantis/foot/fst_mantis_l05.mp3","mantis/foot/fst_mantis_l06.mp3","mantis/foot/fst_mantis_l07.mp3"}
ENT.SoundTbl_MeleeAttack = {"mantis/mantis_armattack01.mp3","mantis/mantis_armattack02.mp3","mantis/mantis_armattack03.mp3","mantis/mantis_armattack04.mp3","mantis/mantis_armattack05.mp3","mantis/mantis_armattack06.mp3","mantis/mantis_armattack07.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"mantis/mantis_hiss01.mp3","mantis/mantis_hiss02.mp3","mantis/mantis_hiss03.mp3","mantis/mantis_hiss04.mp3","mantis/mantis_hiss05.mp3","mantis/mantis_hiss06.mp3"}
ENT.SoundTbl_Death = {"mantis/mantis_death01.mp3","mantis/mantis_death02.mp3","mantis/mantis_death03.mp3","mantis/mantis_death04.mp3"}
ENT.SoundTbl_Idle = {"mantis/mantis_chase_vox01.mp3","mantis/mantis_chase_vox02.mp3","mantis/mantis_chase_vox03.mp3","mantis/mantis_chase_vox04.mp3","mantis/sfx_manitswing01.mp3","mantis/sfx_manitswing02.mp3"}
...
function ENT:CustomOnInitialize()
	self:SetCollisionBounds(Vector(40, 25, 60), Vector(-30, -30, 0))
	self:SetSkin(1)
end
--------------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------------
