...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/gecko/fs_gecko_01.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/gecko/npc_gecko_claw_atk_vox_01.mp3",
	"fosounds/vj_forpnpcs/gecko/npc_gecko_claw_atk_vox_02.mp3",
	"fosounds/vj_forpnpcs/gecko/npc_gecko_claw_atk_vox_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/gecko/npc_gecko_claw_atk_vox_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/gecko/npc_gecko_death_01.mp3",
	"fosounds/vj_forpnpcs/gecko/npc_gecko_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/gecko/npc_gecko_chomp_01.mp3",
	"fosounds/vj_forpnpcs/gecko/npc_gecko_chomp_02.mp3",
	"fosounds/vj_forpnpcs/gecko/npc_gecko_chomp_03.mp3"}
...
ENT.AnimTbl_Flinch = {"hitreaction_torso",
	"hitreaction_rightleg",
	"hitreaction_rightarm",
	"hitreaction_leftleg",
	"hitreaction_leftarm",
	"hitreaction_head"} -- If it uses normal based animation, use this
