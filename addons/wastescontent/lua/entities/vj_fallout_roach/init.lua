...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/roach/npc_roach_foot_01.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/roach/npc_roach_attack_01.mp3",
	"fosounds/vj_forpnpcs/roach/npc_roach_attack_02.mp3",
	"fosounds/vj_forpnpcs/roach/npc_roach_attack_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/roach/npc_roach_attack_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/roach/npc_roach_death_01.mp3",
	"fosounds/vj_forpnpcs/roach/npc_roach_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/roach/npc_roach_death_01.mp3"}
...
ENT.AnimTbl_Flinch = {"h2hequip",
	"h2hunequip"} -- If it uses normal based animation, use this
