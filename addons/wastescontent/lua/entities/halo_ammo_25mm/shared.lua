...
function ENT:SpawnFunction(ply, tr)
	...
	local ent = ents.Create("halo_ammo_25mm")
...
if not IsValid(self) then return end
	...
	util.BlastDamage(self.Entity, (self:OwnerCheck(attacker)), self.Entity:GetPos(), 500, 800)
...
function ENT:Use(activator, caller)
	...
	if (activator:IsPlayer()) and not self.Planted then
		...
		activator:GiveAmmo(5, "25mmGrenade")
		self.Entity:Remove()
	end
end
