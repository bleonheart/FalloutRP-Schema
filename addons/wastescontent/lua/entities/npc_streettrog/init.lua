...
-----------------------------------------------*/
ENT.Model = {"models/fallout/streettrog.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 130
...
ENT.SoundTbl_MeleeAttack = {"streettrog/trog_cannibal01.mp3","streettrog/trog_cannibal02.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {""}
ENT.SoundTbl_Death = {"streettrog/trog_death01.mp3","streettrog/trog_death02.mp3"}
ENT.SoundTbl_Idle = {"streettrog/trog_idle_lp.wav"}
