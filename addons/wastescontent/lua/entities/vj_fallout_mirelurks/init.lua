...
ENT.Model = {"models/fallout/mirelurk.mdl",
	"models/fallout/mirelurk_hunter.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 400
...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/mirelurk/npc_mirelurkking_foot_01.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_attack_01.mp3",
	"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_attack_02.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_attack_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_death_01.mp3",
	"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_idle_01.mp3",
	"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_idle_02.mp3",
	"fosounds/vj_forpnpcs/mirelurk/npc_mirelurk_idle_03.mp3"}
...
ENT.AnimTbl_Flinch = {"hit_torso",
	"hit_legright",
	"hit_legleft",
	"hit_head",
	"hit_armright",
	"hit_armleft"} -- If it uses normal based animation, use this
...
function ENT:MultipleMeleeAttacks()
	...
	if EnemyDistance > 0 and EnemyDistance < 80 then
