...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/giantrat/npc_giantrat_foot_01.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/giantrat/npc_giantrat_attack_01.mp3",
	"fosounds/vj_forpnpcs/giantrat/npc_giantrat_attack_02.mp3",
	"fosounds/vj_forpnpcs/giantrat/npc_giantrat_attack_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/giantrat/npc_giantrat_attack_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/giantrat/npc_giantrat_injured_01.mp3",
	"fosounds/vj_forpnpcs/giantrat/npc_giantrat_injured_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/giantrat/npc_giantrat_idle_chirp.mp3"}
...
function ENT:MultipleMeleeAttacks()
	...
	if EnemyDistance > 0 and EnemyDistance < 50 then
