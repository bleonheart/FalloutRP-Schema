...
ENT.Model = {"models/fallout/albinoradscorpion.mdl",
	"models/fallout/radscorpion.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
ENT.StartHealth = 450
...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/scorps/npc_radscorpion_foot_01.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/scorps/npc_radscorpion_attack_01.mp3",
	"fosounds/vj_forpnpcs/scorps/npc_radscorpion_attack_02.mp3",
	"fosounds/vj_forpnpcs/scorps/npc_radscorpion_attack_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/scorps/npc_radscorpion_attack_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/scorps/npc_radscorpion_death_01.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/scorps/npc_radscorpion_idle_01.mp3",
	"fosounds/vj_forpnpcs/scorps/npc_radscorpion_idle_02.mp3"}
...
ENT.AnimTbl_Flinch = {"specialidle_hittail",
	"specialidle_hitrightarm",
	"specialidle_hitlegright"} -- If it uses normal based animation, use this
