...
ENT.NextRunAwayOnDamageTime = 3 -- Until next run after being shot when not alerted
...
ENT.SoundTbl_FootStep = {"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_foot_run_r.mp3"}
ENT.SoundTbl_MeleeAttack = {"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_poweratk_vox_01.mp3",
	"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_poweratk_vox_02.mp3",
	"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_poweratk_vox_03.mp3"}
ENT.SoundTbl_MeleeAttackMiss = {"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_poweratk_vox_01.mp3"}
ENT.SoundTbl_Death = {"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_death_01.mp3",
	"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_death_02.mp3"}
ENT.SoundTbl_Idle = {"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_idle_01.mp3",
	"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_idle_02.mp3",
	"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_idle_03.mp3",
	"fosounds/vj_forpnpcs/deathclaw/npc_deathclaw_idle_04.mp3"}
...
ENT.AnimTbl_Flinch = {"hittorso",
	"hitlegright",
	"hitlegleft",
	"hithead",
	"hitarmright",
	"hitarmleft"} -- If it uses normal based animation, use this
...
function ENT:MultipleMeleeAttacks()
	...
	if EnemyDistance > 0 and EnemyDistance < 150 then
